...
class Hymnary(models.Model):
    ...
    owner = models.ForeignKey(
        User, verbose_name="Proprietário", on_delete=models.CASCADE
    )
    ...
    songs = models.ManyToManyField(
        Song, verbose_name="Músicas", related_name="hymns", through="HymnarySong"
    )
    TEMPLATE_CHOICES = (
    ...
    template = models.CharField(
        "Modelo", max_length=32, choices=TEMPLATE_CHOICES, default="single-column"
    )
    file = models.FileField("Arquivo", upload_to="hymnaries/", null=True)
